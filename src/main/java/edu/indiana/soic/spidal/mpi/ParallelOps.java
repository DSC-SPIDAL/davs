...
import edu.indiana.soic.spidal.davs.Program;
import edu.indiana.soic.spidal.davs.Range;
import edu.indiana.soic.spidal.davs.RangePartitioner;
...
public class ParallelOps {
    ...
    public static void setupParallelism(String[] args) throws MPIException {
        ...
        if (heterogeneous) {
            DAVectorUtility.SALSAPrint(0,"Running in heterogeneous mode");
        }
        ...
        *  within a node. */
        ...
        if (worldProcRank == 0) {
            DAVectorUtility.SALSAPrint(0, parallelPattern);
        }
    }
    ...
    public static void setParallelDecomposition()
        ...
        // TODO - fix this packet mmap later
        ...
        try (FileChannel mmapCollectiveFc = FileChannel
            ...
            // Note. assuming this (Program.config.getMaxNcentTotal()) would be larger than the number of doubles
            // contributed by a process
            int mmapCollectiveReadByteExtent = Program.config.getMaxNcentTotal() * mmapProcsCount * Double.BYTES;
    ...
    // TODO - fix MPIReducePlusIndex later similar to in DAPWC
